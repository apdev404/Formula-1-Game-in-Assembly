<h1>Formula-1-Game-in-Assembly</h1>
    ...
    <ul>
        ...
        <li>Se nos abrira el siguiente menu previo, y debemos tocar cualquier tecla para avanzar <img src="https://drive.google.com/uc?export=view&id=1wz2lX_RA8Z8oTyvAYoFgMIZTKZeZYP58" alt="" width="600"></li>
        <li>A partir de este punto veremos un menu con las opciones de controles, y la opcion para directamente saltar a jugar <img src="https://drive.google.com/uc?export=view&id=1bw7OKss8K01sQsOCjp5r3YOmzhqZf85Y" alt="" width="600"></li>
        <li>Controles<img src="https://drive.google.com/uc?export=view&id=11wYnjCtes36pubH1wkJDeHZSCqNapHkK" alt="" width="600"></li>
