<h1>Formula-1-Game-in-Assembly</h1>
    ...
    <ul style="list-style-type: none;">
        ...
        <img src="https://drive.google.com/uc?export=view&id=1wz2lX_RA8Z8oTyvAYoFgMIZTKZeZYP58" alt="" width="600">
        <li>A partir de este punto veremos un menu con las opciones de controles, y la opcion para directamente saltar a jugar </li>
        <img src="https://drive.google.com/uc?export=view&id=1bw7OKss8K01sQsOCjp5r3YOmzhqZf85Y" alt="" width="600">
        <li>Controles</li>
